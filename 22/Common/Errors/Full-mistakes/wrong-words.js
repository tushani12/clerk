// wrong words= (wrong words of wordbyword analysis + typo words of word by word analysis) asc1.js

/**
 * Calculate total wrong words (wrong words + typo words)
 * @param {string} originalText - The original passage text
 * @param {string} typedText - The text typed by the user
 * @returns {object} Object containing wrong words count, typo words count, and total wrong words
 */
function calculateTotalWrongWords(originalText, typedText) {
    if (!originalText || !typedText) {
        return { wrongWords: 0, typoWords: 0, totalWrongWords: 0 };
    }
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { calculateTotalWrongWords };
}