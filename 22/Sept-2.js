...
function DPcomprehensiveTypingAnalysis() {
    ...
    function performCompleteAnalysis() {
        ...
        setFieldValue("177164", fullMistakes);
        ...
        setFieldValue("177008", errorCharacters);
        setFieldValue("177165", halfMistakes);

        setFieldValue("177009", htmlOutput.trim());

        // Final
        setFieldValue("177010", accuracyPercentage.toFixed(2) + "%");
        setFieldValue("177011", result);
